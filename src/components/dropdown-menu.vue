...
<template>
  <div class="dropdown">
    ...
    >
      ...
      <span class="toggle" @click="toggleOptions">
        <svg
          v-if="showOptions"
          width="14"
          height="9"
    ...
    <div v-if="!showOptions" class="label">
      {{ label }}
    </div>
    ...
    <div v-if="showOptions" class="options-list">
      ...
      >
        <div class="option" :class="{ bold: selectedOption === option }">
          <svg
            class="profile-icon"
            width="14"
            height="14"
          ...
          >
            <path
              ...
              :stroke="selectedOption === option ? '#000000' : '#6B7280'"
